...
// })
  ...
  // $(this).html("<div id='form'></div>")

  // $(this).children("div").animate({height: "100%", width: "100%"})
  ...
  // div.html("<h1 id=formHead>Hello World</h1>")
  // $("#fifthPage").append("<span id='form'></span>")
  // console.log("Appended")

  // $(".form").append("<p>hello</p>")
})

// Testing the form animation
